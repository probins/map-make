...
System.config({
  depCache: {
    rasters: ['ol.js', 'olMap.js', 'components/layerswitcher', 'components/zoom'],
    vectors: ['ol.js', 'olMap.js', 'components/layerswitcher', 'rasters.js', 'mongo.js'],
    mongo: ['ol.js'],
    'components/addlayer': ['components/addlayer.html',
        'https://cdnjs.cloudflare.com/ajax/libs/awesomplete/1.1.1/awesomplete.min.js',
        'sources/list.json'],
    'components/geolocation': ['components/geolocation.html', 'components/toolbar'],
    'components/layerswitcher': ['components/layerswitcher.html', 'components/toolbar'],
    'components/toolbar': ['components/component', 'components/toolbar.html', 'olMap.js'],
    ...
    'sources/nl/ngr/achter': ['projections/28992'],
...
conf[dir + 'tooltip'].push('measure.js');
conf[dir + 'draw'].push('components/toolbar');
System.config({
  depCache: conf
});
