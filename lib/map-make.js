...
// now we have options, fetch modules specified
  ...
  if (options.rasters) {
    var imports = [System.import('rasters.js')], modName;
    ...
    options.rasters.forEach(function(r) {
      ...
      imports.push(System.import('registry/sources/' + modName + '.js'));
    });
  ...
  if (options.vectors) {
    ...
    return System.import('vectors.js').then(function(vectors) {
  ...
  //   for (var component in options.components) {
    options.components.forEach(function(c) {
      System.import('registry/components/' + c + '.js');
    });
  }
  ...
  if (!options.rasters && !options.vectors) {
    System.import('registry/components/toolbar.js').then(function() {
