...
var registry = 'registry/',
    componentDir = registry + 'components/',
...
System.paths.layerswitcher = componentDir + 'layerswitcher.js';
    ...
    System.import('olMap').then(function(olMapIn) {
      ...
      if (options.components) {
        for (var component in options.components) {
          utils.importComponent(component, 'lib/' + componentDir + component + '.html');
        }
      }
