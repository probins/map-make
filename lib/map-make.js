...
System.config({
  ...
  paths: {
    ...
    'components/*': 'registry/components/*.js',
    'projections/*': 'registry/projections/*.js',
    'sources/*': 'registry/sources/*.js',
    'styles/*': 'registry/styles/*.js',
    'widgets/*': 'registry/widgets/*.js'
  }
});
