...
// now we have options, fetch modules specified
  ...
  if (!(options.components && options.components.mouseposition)) {
    addMouseButton();
  }
...
function addMouseButton() {
  ...
  System.import('components/toolbar').then(function(toolbar) {
    ...
    mouseButton.addEventListener('click', function() {
      System.import('components/mouseposition');
      this.style.display = 'none';
    });
    toolbar.querySelector('#components-content').appendChild(mouseButton);
  });
}
