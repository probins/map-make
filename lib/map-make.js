...
// now we have options, fetch modules specified
  ...
  if (options.rasters) {
    let imports = [import('./rasters.js')], modName;
  ...
  if (!options.rasters && !options.vectors) {
    import('./registry/components/toolbar.js').then(() => {
