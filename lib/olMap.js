...
var switcher = require('registry/widgets/layerswitcher');
...
function addVectorWidgetButtons() {
  ...
  button.addEventListener('click', function() {
    System.import('registry/widgets/tooltip');
    this.style.display = 'none';
  });
  document.getElementById('widgets').appendChild(button);
}
