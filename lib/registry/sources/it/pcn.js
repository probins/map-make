...
const extent = [6, 36, 19, 48];
const resolutions = [0.02,0.007,0.002,0.0007,0.0004,0.0002,0.0001,0.00005,0.000025,0.00001];

const baseUrl = 'http://wms.pcn.minambiente.it/ogc?map=/ms_ogc/WMS_v1.3/raster/';
const mapTypes = ['de_agostini', 'de_agostini', 'de_agostini', 'de_agostini', 'de_agostini',
    'IGM_100000', 'IGM_100000', 'IGM_25000', 'IGM_25000', 'IGM_25000'];
const layerNames = ['CB.DEAGOSTINI', 'CB.DEAGOSTINI', 'CB.DEAGOSTINI', 'CB.DEAGOSTINI',
...
function setUrl(zoom) {
  ...
  layer.get('source').setUrl(baseUrl + mapTypes[zoom] + '.map');
}
