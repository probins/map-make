...
var ol = require('ol');
var proj = require('projections/3763');

var extent = [-170000,-325000,180000,290000];
var resolutions = [1191.40625, 595.703125, 297.8515625, 148.92578125, 74.462890625, 37.2314453125];
...
var sourceOptions = {
  ...
  attributions: [new ol.Attribution({
    html: 'Topo maps &copy; <a target="_blank" href="http://mapas.dgterritorio.pt/">DGT</a>'
  })],
  extent: extent,
