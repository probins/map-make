  ...
  getLayers: function() {
    return [new ol.layer.Tile({
      source: new ol.source.WMTS({
        urls: [
          'http://maps.wien.gv.at/basemap/geolandbasemap/{Style}/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.png',
          'http://maps1.wien.gv.at/basemap/geolandbasemap/{Style}/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.png',
          'http://maps2.wien.gv.at/basemap/geolandbasemap/{Style}/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.png',
          'http://maps3.wien.gv.at/basemap/geolandbasemap/{Style}/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.png',
          'http://maps4.wien.gv.at/basemap/geolandbasemap/{Style}/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.png'
        ],
        format: 'image/png',
        ...
        attributions: [new ol.Attribution({
          html: 'Map base: &copy; <a href="http://www.basemap.at/" target="_blank">' +
              'Austrian Basemap</a>'
        })]
      }),
      extent: extent,
