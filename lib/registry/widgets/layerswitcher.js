var ls = document.importNode(document.getElementById('layerswitcher').content, true);
// create layer switcher divs
var layersDiv = ls.getElementById('layerswitch');
...
module.exports = {
  addRasterDiv: function(layer, switcherRasterHandler) {
    ...
    if (!added.rasters) {
      ...
      document.getElementById('toolbar').appendChild(ls);
    }
  },
