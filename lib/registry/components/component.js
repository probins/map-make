 ...
 * as the js module.
 *
 * toolbar, layerswitcher, zoom are always loaded, toolbar into document.body,
 *   and others with map.addControl().
 * popup is used by featuredisplay/draw and not loaded independently.
 * others are optional, loaded from querystring/mapDef or by button click from
 *   toolbar.
 *
