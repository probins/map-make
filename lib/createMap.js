...
// uses jspm global
  ...
  if (window.location.search) {
    ...
    // and if that doesn't exist either, display initial help text
    if (!mapDef) {
    	jspm.import(htmlDir + 'initialHelp.html!text', function(html) {
  ...
  jspm.import(imports, function(olMap) {
    ...
    jspm.import(imports, function() {
      ...
      if (options.vectors) {
        ...
        olMap.createVectors(options.vectors); // returns layers div
