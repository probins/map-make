...
if (REGISTER) {
  // System.register version in separate repo
  baseURL = baseURL.replace('map-make', 'map-make-register');
}
...
function initSystem() {
  ...
  if (REGISTER) {
    ...
    System.loader = {
      // FIXME should return a promise, like loader.import()
  ...
  System.sourceList = baseURL + 'registry/sources/list.json';
