 ...
 * - set meta config for handling of proj global and plugin file handling
 * - create System.importModule() as frontend for System.import, which can later
...
function initSystemjs() {
  ...
  System.config({
    ...
    meta: {
      // if this isn't present, proj4 global isn't created and ol can't use it
  ...
  System.importModule = function(module) {
    return System.import(configVars.systemConfig.baseURL + module);
  };
