...
System.register(['../../../ol.js', '../../projections/32633.js'], function (_export, _context) {
  var ol, proj, extent, resolutions, baseUrl, mapTypes, layerNames, sourceOptions, layer;
  return {
    ...
    execute: function () {
      extent = [-250078, 3.85602e+006, 889638, 5.27362e+006];
      resolutions = [5, 0.007, 0.002, 0.0007, 0.0004, 0.0002, 0.0001, 0.00005, 0.000025, 0.00001];
